...
def select(update, context):
    ...
    global row
    row = ['2020-03-31', '3500', '2050', '2100', '50', '450', '250', '100', '350', '0', '320', '4970', '4970', 'Cash', '0']
    context.bot.send_message(chat_id=update.effective_chat.id, text="You have choosen Room.",
                                 reply_markup=ReplyKeyboardMarkup(reply_keyboard, one_time_keyboard=True))
